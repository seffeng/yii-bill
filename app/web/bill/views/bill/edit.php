...
<div class="box-primary">
    <div class="box-header"></div>
        ...
        echo $form->field($model, 'b_price', ['inputOptions' => ['placeholder' => '支持简单算术，如：(1+1)*4/2', 'class' => 'form-control', 'value' => $model->b_price / 100]]);
...
$(document).ready(function(){
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {'id': _b_id, 'Bill[b_name]': _name, 'Bill[b_type]': _type, 'Bill[b_price]': _price, 'Bill[b_paytime]': _paytime, 'Bill[b_remark]': _remark};
